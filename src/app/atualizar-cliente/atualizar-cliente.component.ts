...
export class AtualizarClienteComponent implements OnInit {
  ...
  constructor(private _clienteService: ClienteService, private _router:
    Router,
  ...
  atualizar(id: number) {
    this._clienteService.atualizarCliente(id, this.cliente).subscribe(cliente => { this.cliente = new Cliente(0, "", "") },
